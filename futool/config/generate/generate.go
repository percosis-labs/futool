...
var (
	...
	// It's set at build time using an -X flag. eg -ldflags "-X github.com/percosis-labs/futool/config/generate.ConfigTemplatesDir=/home/user1/futool/config/templates"
